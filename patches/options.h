...
#define DSS_PRIV_FILENAME "/data/dropbear/etc/dropbear_dss_host_key"
#endif
#ifndef RSA_PRIV_FILENAME
#define RSA_PRIV_FILENAME "/data/dropbear/etc/dropbear_rsa_host_key"
#endif
...
#define DROPBEAR_PIDFILE "/data/dropbear/var/dropbear.pid"
#endif
...
#define SFTPSERVER_PATH "/data/dropbear/bin/sftp-server"
#endif

/* This is used by the scp binary when used as a client binary. If you're
 * not using the Dropbear client, you'll need to change it */
#define _PATH_SSH_PROGRAM "/data/dropbear/bin/dbclient"
